...
class Squash(nn.Module):
    ...
    def __init__(self,in_min, in_max, out_min, out_max) -> None:
...
class DiagonalGaussianSample(nn.Module):
    ...
    def forward(self,mean,log_std) -> torch.Tensor:
...
class TanhDiagonalGaussianLogProb(nn.Module):
    ...
    def forward(self,gaussian_samples, tanh_gaussian_samples, mean, log_std) -> torch.Tensor:
